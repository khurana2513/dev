...
- Name: admin.spec.ts >> @admin exams page shows create button
- Location: e2e/admin.spec.ts:73:1
...
Locator: locator('button:has-text(\'New Exam\')')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('button:has-text(\'New Exam\')')
