...
- Name: admin.spec.ts >> @admin header shows admin nav links
- Location: e2e/admin.spec.ts:147:1
...
Call log:
  - waiting for locator('header').locator('button').filter({ has: locator('.rounded-full') }).first()
