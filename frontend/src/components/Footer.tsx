...
import { GraduationCap, Phone, Instagram, MapPin, Calculator, Brain, Zap, FileText, Grid3X3, Sparkles } from "lucide-react";
          ...
          <div className="col-span-2 sm:col-span-3 lg:col-span-1">
            ...
            <div className="flex flex-wrap gap-2">
              {([
                ...
                ["https://www.instagram.com/blackmonkey", "📸 Instagram", <Instagram size={15} key="i" />],
